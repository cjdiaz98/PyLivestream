...
class TaskStatusResult:
	...
	"""
	def __init__(self, url: str, request_id: str, task_id: str, duration: Optional[float], status: str):
		self.url = url
...
import time
def process_kling_tasks(get_task_call, task_ids, timeout=300) -> Dict[str, str]:
	"""
...
if __name__ == "__main__":
	...
	print(send_get_image2vid_task_request("CmBhnmePZ8YAAAAAAQ7wqQ"))
